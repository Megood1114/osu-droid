...
// TODO: Port difficulty calculators
...
public enum BeatmapDifficultyCalculator {
    ...
    // TODO: Port performance calculation - StatisticV2, DroidPerformanceCalculationParameters not yet available
...
//    }
    ...
    // TODO: Port performance calculation - StatisticV2, StandardPerformanceCalculationParameters not yet available
...
//    }
    ...
    // TODO: Port difficulty calculation - DroidDifficultyCalculator not yet available
...
//        if let cached = difficultyCacheManager[beatmap.md5]?.getDroidDifficultyCache(mods: beatmap.mods, forReplay: false) {
//            return cached
//        }
...
//        if let cached = difficultyCacheManager[beatmap.md5]?.getDroidDifficultyCache(mods: beatmap.mods, forReplay: true) {
//            return cached
//        }
//        let attributes = droidDifficultyCalculator.calculate(beatmap: beatmap)
//        addCache(beatmap: beatmap, attributes: attributes, forReplay: true)
...
//        if let cached = difficultyCacheManager[beatmap.md5]?.getDroidTimedDifficultyCache(mods: beatmap.mods) {
//            return cached
//        }
...
//    }
    ...
    // TODO: Port difficulty calculation - StandardDifficultyCalculator not yet available
//    /// Calculates the difficulty of a `Beatmap` with specific `Mod`s.
...
//        if let cached = difficultyCacheManager[beatmap.md5]?.getStandardDifficultyCache(mods: beatmap.mods) {
//            return cached
//        }
...
//        if let cached = difficultyCacheManager[beatmap.md5]?.getStandardTimedDifficultyCache(mods: beatmap.mods) {
//            return cached
//        }
...
//    }
    ...
    // TODO: Port performance calculation - StatisticV2, DroidPerformanceCalculator, DroidPerformanceCalculationParameters not yet available
...
//    }
    ...
    // TODO: Port performance calculation - Replay, StatisticV2, DroidPerformanceCalculator not yet available
...
//    }
    ...
    // TODO: Port performance calculation - StatisticV2, StandardPerformanceCalculator, StandardPerformanceCalculationParameters not yet available
...
//    }
    ...
    // TODO: Port performance calculation - ReplayObjectData, StatisticV2 not yet available
...
private class BeatmapDifficultyCacheManager {
    ...
    private func processMods(mods: [Mod]?, mode: GameMode) -> [Mod] {
        ...
        // TODO: Port difficulty calculators - retainDifficultyAdjustmentMods not yet available
        // switch mode {
        // case .droid:
